...
import sim.util.SAbstractReadable;
...
public class SConfiguration extends SAbstractReadable {
   ...
   */
	 ...
	 */
	private static final String DEFAULT_READ_DATA_FILE_NAME = "default_scene.txt";	  
	 ...
	 */
	private static final String DEFAULT_WRITE_DATA_FILE_NAME = "out.txt";	
