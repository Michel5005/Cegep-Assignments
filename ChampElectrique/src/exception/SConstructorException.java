...
public class SConstructorException extends RuntimeException {
  ...
  /**
   * La constante <b>DEFAULT_MESSAGE</b> représente le message par défaut lancée par une erreur de ce type.
   */
  private static final String DEFAULT_MESSAGE = "Une erreur de construction est survenue.";
  
  /**
   * Constructeur de l'exception avec un message par défaut.
   */
  public SConstructorException()
  {
  ...
  /**
   * Constructeur de l'exception avec le message par défaut et la cause.
   * @param cause
   */
  public SConstructorException(Throwable cause)
  {
