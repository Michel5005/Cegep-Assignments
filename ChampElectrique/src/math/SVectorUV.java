...
public class SVectorUV implements SVector {
   ...
   */
  public SVectorUV(String string)throws SConstructorException
  {
    try {
      ...
      throw new SConstructorException("Erreur SVectorUV 001 : L'argument '" + string + "' n'est pas valide pour définir un vecteur uv.", e);
    }
  }
   ...
   * @throws IllegalArgumentException Si le format de lecture n'est pas adéquat.
   */
  private double[] read(String string) throws IllegalArgumentException
  {
    ...
    if(tokens.countTokens() != 2)
      throw new IllegalArgumentException("Erreur SVectorUV 003 : L'expression '" + string + "' ne contient pas exactement 2 paramètres pour les composantes uv du vecteur uv.");
    else
    {
      ...
      try
      {
        ...
        throw new IllegalArgumentException("Erreur SVectorUV 004 : L'expression '" + s +"' n'est pas valide pour définir la composante '" + comp + "' du vecteur en cours.", e);
      }
    } 
  }
