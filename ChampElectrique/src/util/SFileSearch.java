...
/**
 * La classe <b>SFileSearch</b> permet la recherche d'un nom de <u>fichier</u> à partir d'un emplacement dans un ensemble de répertoire 
...
public class SFileSearch {
  ...
  {
    return !file_found_list.isEmpty();
  }
