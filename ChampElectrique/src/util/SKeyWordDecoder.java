...
public class SKeyWordDecoder {
  ...
  public static final String KW_EMPTY_GEOMETRY = "empty_geometry";
  public static final int CODE_EMPTY_GEOMETRY = 100; 
  
  public static final String KW_MATRIX = "matrix";
  public static final String KW_MATRICE = "matrice";
  public static final int CODE_MATRIX = 101;
  
  public static final String KW_LINE = "line";
  public static final String KW_LIGNE = "ligne";
  public static final int CODE_LINE = 102;
  
  public static final String KW_AGGREGATION_FUNCTION = "aggregation_function";
  public static final int CODE_AGGREGATION_FUNCTION = 103;
  
  public static final String KW_ACTIVATION_FUNCTION = "activation_function";
  public static final int CODE_ACTIVATION_FUNCTION = 104;
  
  public static final String KW_BIAS = "bias";
  public static final int CODE_BIAS = 105;
  
  public static final String KW_FULL_CONNECTED_LAYER = "full_connected_layer";
  public static final int CODE_FULL_CONNECTED_LAYER = 106;
  
  public static final String KW_NEURAL_NETWORK = "neural_network";
  public static final int CODE_NEURAL_NETWORK = 107;
  
  public static final String KW_FILE_NAME = "file_name";
  public static final int CODE_FILE_NAME = 108;
  
  public static final String KW_COMMENT = "comment";
  public static final int CODE_COMMENT = 109;
  
  public static final String KW_X_MIN = "x_min";
  public static final int CODE_X_MIN = 110;
  
  public static final String KW_X_MAX = "x_max";
  public static final int CODE_X_MAX = 111;
  
  public static final String KW_Y_MIN = "y_min";
  public static final int CODE_Y_MIN = 112;
  
  public static final String KW_Y_MAX = "y_max";
  public static final int CODE_Y_MAX = 113;
  
  public static final String KW_IMAGE_FUNCTION = "image_function";
  public static final int CODE_IMAGE_FUNCTION = 114;
  
  public static final String KW_STATE = "state";
  public static final int CODE_STATE = 115;

  public static final String KW_VALUE = "value";
  public static final int CODE_VALUE = 116;
  
  public static final String KW_SPEED= "speed";
  public static final int CODE_SPEED = 117;
  public static final String KW_MASS= "mass";
  public static final int CODE_MASS = 118;
  
  public static final String KW_HIERARCHICAL = "hierarchical_geometry";
  public static final int CODE_HIERARCHICAL = 119;
  
  public static final String KW_SHADOW = "shadow";
  public static final int CODE_SHADOW = 120;
  
  public static final String KW_POINT_SPOT_LIGHT = "point_spot_light";
  public static final int CODE_POINT_SPOT_LIGHT = 121;
  
  public static final String KW_CONVOLUTION_LAYER = "convolution_layer";
  public static final int CODE_CONVOLUTION_LAYER = 122;
  
  public static final String KW_SHIFT = "shift";
  public static final int CODE_SHIFT = 123;
  
  public static final String KW_BATCH_FULL_CONNECTED_LAYER = "batch_full_connected_layer";
  public static final int CODE_BATCH_FULL_CONNECTED_LAYER = 124;
  
  public static final String KW_DEPTH = "depth";
  public static final int CODE_DEPTH = 125;
  
  public static final String KW_FILTERS = "filters";
  public static final int CODE_FILTERS = 126;
  
  public static final String KW_STRIDE = "stride";
  public static final int CODE_STRIDE = 127;
  
  public static final String KW_PADDING = "padding";
  public static final int CODE_PADDING = 128;
  
  public static final String KW_INPUT_SIZE = "input_size";
  public static final int CODE_INPUT_SIZE = 129;
  
  public static final String KW_INPUT_DEPTH = "input_depth";
  public static final int CODE_INPUT_DEPTH = 130;
  
  public static final String KW_DROPOUT_LAYER = "dropout_layer";
  public static final int CODE_DROPOUT_LAYER = 131;
  
  public static final String KW_DROPOUT = "dropout";
  public static final int CODE_DROPOUT = 132;
  
  public static final String KW_POOLING_LAYER = "pooling_layer";
  public static final int CODE_POOLING_LAYER = 133;
  
  public static final String KW_POOLING_FUNCTION = "pooling_function";
  public static final int CODE_POOLING_FUNCTION = 134;
  
  public static final String KW_FILTER_OFFSET = "filter_offset";
  public static final int CODE_FILTER_OFFSET = 135;
  
  public static final String KW_BATCH_NETWORK = "batch_network";
  public static final int CODE_BATCH_NETWORK = 136;
  
  public static final String KW_BATCH_CONVOLUTION_LAYER = "batch_convolution_layer";
  public static final int CODE_BATCH_CONVOLUTION_LAYER = 137;
  
  public static final String KW_TRAINABLE = "trainable";
  public static final int CODE_TRAINABLE = 138;
  
  public static final String KW_WEIGHTS = "weights";
  public static final int CODE_WEIGHTS = 139;
      
  public static final String KW_ACTIVATION_PARAMETERS = "activation_parameters";
  public static final int CODE_ACTIVATION_PARAMETERS = 140;
  
  public static final String KW_SPHERE_LIGHT = "sphere_light";
  public static final int CODE_SPHERE_LIGHT = 141;
  
  public static final String KW_NB_POINT_LIGHT = "nb_point_light";
  public static final int CODE_NB_POINT_LIGHT = 142;
  
  public static final String KW_SPHERE_UNIFORMLY_CHARGED = "sphere_uniformly_charged";
  public static final String KW_SPHERE_UNIFORMEMENT_CHARGEE = "sphère_uniformément_chargée";
  public static final int CODE_SPHERE_UNIFORMLY_CHARGED = 143;
  
  public static final String KW_INFINITE_PLATE_UNIFORMLY_CHARGED = "infinite_plate_uniformly_charged";
  public static final String KW_PPIUC = "ppiuc";
  public static final int CODE_INFINITE_PLATE_UNIFORMLY_CHARGED = 144;
  
  public static final String KW_SURFACE_CHARGE_DENSITY = "surface_charge_density";
  public static final int CODE_SURFACE_CHARGE_DENSITY = 145;
  
  public static final String KW_LINEAR_CHARGE_DENSITY = "linear_charge_density";
  public static final int CODE_LINEAR_CHARGE_DENSITY = 146;
  
  public static final String KW_FINITE_ROD_UNIFORMLY_CHARGED = "finite_rod_uniformly_charged";
  public static final String KW_TRUC = "truc";
  public static final int CODE_FINITE_ROD_UNIFORMLY_CHARGED = 147;
  
  public static final String KW_INFINITE_ROD_UNIFORMLY_CHARGED = "infinite_rod_uniformly_charged";
  public static final String KW_TRIUC = "triuc";
  public static final int CODE_INFINITE_ROD_UNIFORMLY_CHARGED = 148;
  
  public static final String KW_MULTIPLICATOR_OF_TEN = "multiplicator_of_ten";
  public static final String KW_MULTIPLICATEUR_DE_DIX = "multiplicateur_de_dix";
  public static final int CODE_MULTIPLICATOR_OF_TEN = 149;
  
  public static final String KW_MULTIPLICATOR_OF_POWER = "multiplicator_of_power";
  public static final String KW_MULTIPLICATEUR_DE_PUISSANCE = "multiplicateur_de_puissance";
  public static final int CODE_MULTIPLICATOR_OF_POWER = 150;
  
  public static final String KW_FIELD_SETUP = "field_setup";
  public static final int CODE_FIELD_SETUP = 151;
  
  public static final String KW_NB = "nb";
  public static final int CODE_NB = 152;
  ...
  private static Map<String, Integer> buildDataBase()
    ...
    map.put(KW_EMPTY_GEOMETRY, new Integer(CODE_EMPTY_GEOMETRY));
    
    map.put(KW_MATRIX, new Integer(CODE_MATRIX));
    map.put(KW_MATRICE, new Integer(CODE_MATRIX));
    
    map.put(KW_LINE, new Integer(CODE_LINE));
    map.put(KW_LIGNE, new Integer(CODE_LINE));
    
    map.put(KW_AGGREGATION_FUNCTION, new Integer(CODE_AGGREGATION_FUNCTION));
    
    map.put(KW_ACTIVATION_FUNCTION, new Integer(CODE_ACTIVATION_FUNCTION));
    
    map.put(KW_BIAS, new Integer(CODE_BIAS));
    
    map.put(KW_FULL_CONNECTED_LAYER, new Integer(CODE_FULL_CONNECTED_LAYER));
    
    map.put(KW_NEURAL_NETWORK, new Integer(CODE_NEURAL_NETWORK));
    
    map.put(KW_FILE_NAME, new Integer(CODE_FILE_NAME));
    
    map.put(KW_COMMENT, new Integer(CODE_COMMENT));
    
    map.put(KW_X_MIN, new Integer(CODE_X_MIN));
    map.put(KW_X_MAX, new Integer(CODE_X_MAX));
    map.put(KW_Y_MIN, new Integer(CODE_Y_MIN));
    map.put(KW_Y_MAX, new Integer(CODE_Y_MAX));
    
    map.put(KW_IMAGE_FUNCTION, new Integer(CODE_IMAGE_FUNCTION));
    
    map.put(KW_STATE, new Integer(CODE_STATE));
    
    map.put(KW_VALUE, new Integer(CODE_VALUE));
    
    map.put(KW_SPEED, new Integer(CODE_SPEED));
    map.put(KW_MASS, new Integer(CODE_MASS));
    
    map.put(KW_HIERARCHICAL, new Integer(CODE_HIERARCHICAL));
    
    map.put(KW_SHADOW, new Integer(CODE_SHADOW));
    
    map.put(KW_POINT_SPOT_LIGHT, new Integer(CODE_POINT_SPOT_LIGHT));
    
    map.put(KW_CONVOLUTION_LAYER, new Integer(CODE_CONVOLUTION_LAYER));
    
    map.put(KW_SHIFT, new Integer(CODE_SHIFT));
    
    map.put(KW_BATCH_FULL_CONNECTED_LAYER, new Integer(CODE_BATCH_FULL_CONNECTED_LAYER));
    
    map.put(KW_DEPTH, new Integer(CODE_DEPTH));
    map.put(KW_FILTERS, new Integer(CODE_FILTERS));
    
    map.put(KW_PADDING, new Integer(CODE_PADDING));
    map.put(KW_STRIDE, new Integer(CODE_STRIDE));
    map.put(KW_INPUT_SIZE, new Integer(CODE_INPUT_SIZE));
    map.put(KW_INPUT_DEPTH, new Integer(CODE_INPUT_DEPTH));
       
    map.put(KW_DROPOUT_LAYER, new Integer(CODE_DROPOUT_LAYER));
    map.put(KW_DROPOUT, new Integer(CODE_DROPOUT));
    
    map.put(KW_POOLING_LAYER, new Integer(CODE_POOLING_LAYER));
    map.put(KW_POOLING_FUNCTION, new Integer(CODE_POOLING_FUNCTION));
    map.put(KW_FILTER_OFFSET, new Integer(CODE_FILTER_OFFSET));
    
    map.put(KW_BATCH_NETWORK, new Integer(CODE_BATCH_NETWORK));
    
    map.put(KW_BATCH_CONVOLUTION_LAYER, new Integer(CODE_BATCH_CONVOLUTION_LAYER));
    
    map.put(KW_TRAINABLE, new Integer(CODE_TRAINABLE));
    
    map.put(KW_WEIGHTS, new Integer(CODE_WEIGHTS));
    
    map.put(KW_ACTIVATION_PARAMETERS, new Integer(CODE_ACTIVATION_PARAMETERS));
    
    map.put(KW_SPHERE_LIGHT, Integer.valueOf(CODE_SPHERE_LIGHT));
    
    map.put(KW_NB_POINT_LIGHT, Integer.valueOf(CODE_NB_POINT_LIGHT));
    
    map.put(KW_SPHERE_UNIFORMLY_CHARGED, Integer.valueOf(CODE_SPHERE_UNIFORMLY_CHARGED));
    map.put(KW_SPHERE_UNIFORMEMENT_CHARGEE, Integer.valueOf(CODE_SPHERE_UNIFORMLY_CHARGED));
    
    map.put(KW_INFINITE_PLATE_UNIFORMLY_CHARGED, Integer.valueOf(CODE_INFINITE_PLATE_UNIFORMLY_CHARGED));
    map.put(KW_PPIUC, Integer.valueOf(CODE_INFINITE_PLATE_UNIFORMLY_CHARGED));
    
    map.put(KW_SURFACE_CHARGE_DENSITY, Integer.valueOf(CODE_SURFACE_CHARGE_DENSITY)); 
    
    map.put(KW_LINEAR_CHARGE_DENSITY, Integer.valueOf(CODE_LINEAR_CHARGE_DENSITY));
    
    map.put(KW_FINITE_ROD_UNIFORMLY_CHARGED, Integer.valueOf(CODE_FINITE_ROD_UNIFORMLY_CHARGED));
    map.put(KW_TRUC, Integer.valueOf(CODE_FINITE_ROD_UNIFORMLY_CHARGED));
    
    map.put(KW_INFINITE_ROD_UNIFORMLY_CHARGED, Integer.valueOf(CODE_INFINITE_ROD_UNIFORMLY_CHARGED));
    map.put(KW_TRIUC, Integer.valueOf(CODE_INFINITE_ROD_UNIFORMLY_CHARGED));
    
    map.put(KW_MULTIPLICATOR_OF_TEN, Integer.valueOf(CODE_MULTIPLICATOR_OF_TEN));
    map.put(KW_MULTIPLICATEUR_DE_DIX, Integer.valueOf(CODE_MULTIPLICATOR_OF_TEN));
    
    map.put(KW_MULTIPLICATOR_OF_POWER, Integer.valueOf(CODE_MULTIPLICATOR_OF_POWER));
    map.put(KW_MULTIPLICATEUR_DE_PUISSANCE, Integer.valueOf(CODE_MULTIPLICATOR_OF_POWER));
    
    map.put(KW_FIELD_SETUP, Integer.valueOf(CODE_FIELD_SETUP));
    
    map.put(KW_NB, Integer.valueOf(CODE_NB));
