...
public class SStringUtil {
  ...
  /**
   * Méthode pour obtenir un string après avoir retiré l'ensemble des caractères qui ne sont pas des lettres
   * et les remplacer par un caractère spécifique. Seule les caractères minuscules et majuscules seront conservées et non remplacés.
   * 
   * @param string Le mot.
   * @param replacement Le caractère de remplacement.
   * @return Le mot modifié.
   */
  public static String replaceAllNonAlphaCaracter(String string, char replacement)
  {
    char[] array = new char[string.length()];
    
    // Itéaraion sur l'ensemble des caractères.
    for(int i = 0; i < array.length; i++)
    {
      switch(string.charAt(i))
      {
        ...
        array[i] = string.charAt(i); break;
        
        // Remplacer le caractère.
        default : array[i] = replacement;
      }
    }
