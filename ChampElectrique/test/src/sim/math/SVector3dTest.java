...
public class SVector3dTest {
  ...
  /**
   * Test de la méthode <b>dot</b> dans un cas simple avec vecteur unitaire.
   */
  @Test
  ...
  /**
   * Test de la méthode <b>dot</b> dans un cas quelconque où le résultat est positif (Backcoverage).
   */
  @Test
  public void dotTest2a()
  {
    try{
      
      SVector3d a = new SVector3d(3.5, -3.2, 5.9);
      SVector3d b = new SVector3d(6.7, 7.2, 8.3);
      
      Assert.assertEquals(49.38, a.dot(b), 0.000001);
      Assert.assertEquals(49.38, b.dot(a), 0.000001);
    
    }catch(SNoImplementationException e){
      SLog.logWriteLine("SVector3dTest ---> Test non effectué : public void dotTest2a()");
    }
  }
  
  /**
   * Test de la méthode <b>dot</b> dans un cas quelconque où le résulat est négatif (Backcoverage).
   */
  @Test
  public void dotTest2b()
  {
    try{
      
      SVector3d a = new SVector3d(4.5, 3.2, -8.9);
      SVector3d b = new SVector3d(-6.7, 7.2, 10.3);
      
      Assert.assertEquals(-98.78, a.dot(b), 0.000001);
      Assert.assertEquals(-98.78, b.dot(a), 0.000001);
    
    }catch(SNoImplementationException e){
      SLog.logWriteLine("SVector3dTest ---> Test non effectué : public void dotTest2b()");
    }
  }
  
  /**
   * Test de la méthode <b>cross</b> dans un cas simple avec vecteur unitaire.
   */
  @Test
  ...
  /**
   * Test de la méthode <b>cross</b> pour valider la propriété a . ( a x b ) = 0 pour des vecteurs a et b quelconques.
   */
  @Test
  ...
  /**
   * Test de la méthode <b>cross</b> dans un cas quelconque (Backcoverage).
   */
  @Test
  public void crossTest3()
  {
    try{
      ...
      SVector3d a = new SVector3d(3.0, 2.0, 7.0);
      SVector3d b = new SVector3d(1.0, -7.0, 5.0);
        
      Assert.assertEquals(new SVector3d(59.0, -8.0, -23.0), a.cross(b));
      
    }catch(SNoImplementationException e){
      SLog.logWriteLine("SVector3dTest ---> Test non effectué : public void crossTest3()");
    }
  }
  ...
  /**
   * Test de la méthode <b>equals</b> pour un cas quelconque où l'on considère
   * la variable SMath.EPSILON comme étant le seuil de tolérance de la précision.
   */
  @Test
  public void equalsTest1() 
  {
    ...
    SVector3d v4 = new SVector3d(0.0, 1.0, 1.000001);
    ...
    // Ce critère est supposé être FAUX, donc pas d'affichage !!!
    if(v1.equals(v4))
      SLog.logWriteLine("SVector3dTest ---> Test de equals spécial : " + "v1=" + v1 + " =?= " + "v2=" + v2);
    
    Assert.assertNotEquals(v1, v4);   // Remarque : Ce test est aléatoirement en échec à certain moment ... pourquoi ???
  ...
  /**
   * JUnit Test de la méthode <b>isUnitVector</b> dans le cas d'un vecteur unitaire.
   */
  @Test
  public void isUnitVectorTest1()
  {
    try{
      
      Assert.assertTrue(SVector3d.UNITARY_X.isUnitVector());
      Assert.assertTrue(SVector3d.UNITARY_Y.isUnitVector());
      Assert.assertTrue(SVector3d.UNITARY_Z.isUnitVector());
           
      Assert.assertTrue((new SVector3d(3.0/5.0, 4.0/5.0, 0.0)).isUnitVector());
      
    }catch(SNoImplementationException e){
      SLog.logWriteLine("SVector3dTest ---> Test non effectué : public void isUnitVectorTest1()");
    }
  }
  
  /**
   * JUnit Test de la méthode <b>isUnitVector</b> dans le cas d'un vecteur non unitaire.
   */
  @Test
  public void isUnitVectorTest2()
  {
    try{
      
      Assert.assertFalse((new SVector3d(3.4, 2.1, -4.5)).isUnitVector());
              
      Assert.assertFalse((new SVector3d(3.0/6.0, 4.0/6.0, 0.0)).isUnitVector());
      
    }catch(SNoImplementationException e){
      SLog.logWriteLine("SVector3dTest ---> Test non effectué : public void isUnitVectorTest2()");
    }
  }
  
  /**
   * JUnit Test de la méthode <b>isZero</b> dans des cas simple.
   */
  @Test
  public void isZero()
  {
    try{
      ...
      Assert.assertTrue((new SVector3d(0.0, 0.0, 0.0)).isZero());
      
      Assert.assertFalse((new SVector3d(1e-87, 0.0, 0.0)).isZero());
      Assert.assertFalse((new SVector3d(0.0, 1e-87, 0.0)).isZero());
      Assert.assertFalse((new SVector3d(0.0, 0.0, 1e-87)).isZero());
