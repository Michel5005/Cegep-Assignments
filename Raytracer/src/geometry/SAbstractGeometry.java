...
public abstract class SAbstractGeometry extends SAbstractReadableWriteable implements SGeometry {
   ...
   * 
	...
	public boolean equals(Object other)
	{
	  ...
	  //------------------------------------------------------------------------------------
	  // REMARQUE : Puisque chaque géométrie aura sa propre ID, je ne peux pas utiliser
	  //            ce paramètre dans le equals(...), car autrement, ce sera toujours faux.
	  //------------------------------------------------------------------------------------
  ...
  {
    return "SAbstractGeometry [name=" + getReadableName() + ", id=" + id + "]";
  }
