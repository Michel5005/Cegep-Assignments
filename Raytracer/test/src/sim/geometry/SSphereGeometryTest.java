...
public class SSphereGeometryTest {
   ...
   *
   * Ce test sera valide avec le critère t > 0. 
   */
  @Test
   ...
   * Test de l'intersection <u>avec 1 succès</u> entre un rayon et une sphère tel que le rayon <u>par de la surface de la sphère vers l'intérieur de la sphère</u>.
   * 
   * Ce critère ne sera pas valide si t > 0, mais si t > 0+.
   */
  @Test
  public void intersectionTest6b()
  {
    ...
    SRay ray = new SRay(center.add( new SVector3d(3.2, 6.7, 2.3).normalize().multiply(R+SRay.getEpsilon()*0.01)), new SVector3d(-1.0, -2.0, -3.0), 1.0);
