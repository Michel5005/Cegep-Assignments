...
public class STransformableGeometryTest {
  ...
  /**
   * Test de la méthode intersection avec l'usage de la géométrie <b>SCubeGeometry</b> dans le cas où il y aura uniquement une transformation d'homothétie (back coverage). 
   * Dans ce test, il y <u>aura intersection</u>.
   */
  @Test
   ...
   * La normale "normalisée" sera la même dans l'espace monde et objet.
   * 
  ...
  /**
   * Test de la méthode intersection avec l'usage de la géométrie <b>SCubeGeometry</b> dans un cas général. 
   * Dans ce test, il y <u>aura intersection</u> et la normale de l'espace objet devra être transformée vers l'espace monde et normalisée.
   */
  @Test
