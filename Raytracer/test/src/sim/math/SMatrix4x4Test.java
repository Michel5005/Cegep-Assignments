...
public class SMatrix4x4Test {
   ...
   */
  @Test
  public void RxyzAndRzyxIdentityTest() 
  {
    try{
    ...
    Assert.assertEquals(SMatrix4x4.identity(), SMatrix4x4.Rzyx(v).multiply(SMatrix4x4.Rxyz(inv_v)));
      ...
      SLog.logWriteLine("SMatrix4x4Test ---> Test non effectué : public void RxyzAndRzyxIdentityTest()");
    }
  }
  
  /**
   * JUnit test de la méthode <b>TrRzyxSc</b> dans un cas général.
   */
  @Test
  ...
  /**
   * JUnit test de la méthode <b>ScRxyzTr</b> dans un cas général.
   */
  @Test
   ...
   */
  @Test
  public void TrRzyxScAndScRxyzTrIdentityTest() 
  {
    try{
    ...
    Assert.assertEquals(SMatrix4x4.identity(), SMatrix4x4.ScRxyzTr(scale, rotation, translation).multiply(SMatrix4x4.TrRzyxSc(translation_inv, rotation_inv, scale_inv)));
      ...
      SLog.logWriteLine("SMatrix4x4Test ---> Test non effectué : public void TrRzyxScAndScRxyzTrIdentityTest");
    }
  }
