...
public class FlecheVectorielle implements Dessinable {
	...
	/** Angle initiale entre les deux droites formant la pointe de la flèche */
	private double angleTete = 30; // en degres, angle par defaut entre les deux segments formant la tete de fleche
	/** Longeur des traits servants à faire la pointe de la flèche */
	private double longueurTraitDeTete = 0.01;
	/**
	 * Longueur par defaut des segments formant la tete. Convertion de pixels en
	 * mètres
	 */
	...
	/**
	 * Méthode qui s'occupe à faire en sorte que c'est le point d'origine
	 * 
	 * @param x Le x de la flèche
	 * @param y Le y de la flèche
	 */
	...
	/**
	 * Modifie la couleur de la flèche et récreer la flèche avec la nouvelle couleur
	 * 
	 * @param couleurFleche La couleur de la flèche
	 */
