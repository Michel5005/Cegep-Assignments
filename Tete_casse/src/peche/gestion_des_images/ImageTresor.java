...
/**
 * Classe qui s'occupe de l'image du trésor
 * 
 * @author Michel Vuu
 *
 */

public class ImageTresor {
	 ...
	 */
	public ImageTresor(double x, double y, double largeur, double hauteur, URL image) {
		this.x = x;
		this.y = y;
	...
	/**
	 * Retourne la position en x du trésor
	 * 
	...
	/**
	 * Modifie la valeur de la position en x du trésor
	 * 
	...
	/**
	 * Retourne la position en y du trésor
	 * 
	...
	/**
	 * Modifie la valeur de la position en y du trésor
	 * 
	...
	/**
	 * Modifie la valeur de la largeur du trésor
	 * 
	...
	/**
	 * Modifie la valeur de la hauteur du trésor
	 * 
