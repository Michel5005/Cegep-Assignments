...
public class FenetreAideInstructions extends JFrame {
	 ...
	 * @param tableauImages le tableau des images
	 */
	public FenetreAideInstructions(String tableauImages[]) {
	...
	public JLabel getLblAttention() {
		return lblAttention;
	}

	public void setLblAttention(JLabel lblAttention) {
		this.lblAttention = lblAttention;
	}
