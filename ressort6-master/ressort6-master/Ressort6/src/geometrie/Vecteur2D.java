 ...
 * 
 * **ATTENTION***
 * Les identifiants x et y sont utilisés dans cette classe non pas pour représenter
 * des position, mais bien pour représenter des composantes!!
 * 
 * Cette classe est une version 2d modifiée et augmentée de la classe SVector3d ecrite par Simon Vezina dans le cadre du cours de physique.
 * 
 * @author Simon Vézina
