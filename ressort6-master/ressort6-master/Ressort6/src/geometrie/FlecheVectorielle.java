 ...
 * programmeur désire utiliser cette fleche pour illustrer visuellement un
...
public class FlecheVectorielle implements Dessinable {
	...
	/**
	 * Position x du point de départ de la flèche en mètres.
	 */
	private double x1, y1;

	/**
	 * Position y du point d'arrivée de la flèche en mètres.
	 */
	...
	/**
	 * Angle entre les deux segments formant la tête de la flèche en degrés.
	 */
	private double angleTete = 30;

	/**
	 * Longueur des segments formant la tête de la flèche en mètres.
	 */
	 ...
	 * composantes (longueurs des déplacements en x et en y pour déterminer ou se
	 ...
	 * trouve la pointe de la fleche)
	 * 
	 * @param pos vecteur qui specifie les composantes dx et dy de l'origine
	 * @param vec vecteur qui specifie les composantes dx et dy du vecteur
	 */
	public FlecheVectorielle(Vecteur2D pos, Vecteur2D vec) {
		this.x1 = pos.getX();
		this.y1 = pos.getY();
		this.x2 = x1 + vec.getX();
		this.y2 = y1 + vec.getY();
	 ...
	 * (longueurs des déplacements en x et en y pour déterminer ou se trouve la
	 * pointe de la fleche)
	 * 
	 * @param x1 origine en x
	 * @param y1 origine en y
	...
	private void creerLaGeometrie() {
		 ...
		 * confond avec le corps de la flèche. En ajoutant des rotations a ce trait au
	 ...
	 * spécifié. L'orgine de la fleche demeure la même, mais sa deuxieme extremite
